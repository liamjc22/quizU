...
class QuestionCardState extends State<QuestionCard> {
  ...
  // void _printQuestion(){
  //   print(this.widget.question.answers);
  //   print(this.widget.question.answer);
  //   print(this.widget.question.question);
  // }
  ...
  List<Widget> _getChoices() {
    ...
    for (int i = 0; i < 4; i++) {
      ...
      TextEditingController controller = new TextEditingController(text: this.widget.question.answers[i]);
      controller.addListener((){
        ...
        Widget widget = RadioListTile<int>(
          title: TextField(
              maxLines: 2,
              decoration: InputDecoration.collapsed(hintText: "Answer ${i+1}"),
              controller: controller
          ),
          value: i,
          groupValue: answer,
          onChanged: (int value) { setState(() {answer = value; _saveAnswer(); _saveQuestion(); }); },
        );
      choices.add(widget);
    }
    ...
    return new Card(
      ...
      child: Padding(
        ...
        child: Column(children: <Widget>[
          Row(
            children: [
              IconButton(icon: Icon(Icons.delete), onPressed: _deleteQuestion),
          ...
          TextField(
              maxLines: 3,
              decoration: InputDecoration.collapsed(hintText: "Quesion"),
              controller: questionController,
          ),

          Column(children: _getChoices(),)
